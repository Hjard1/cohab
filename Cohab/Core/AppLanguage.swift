...
""") }
    ...
    var addAssetEquityTitle: String { s(en: "Purchase equity?", nb: "Egenkapital ved kjøp?", sv: "Eget kapital vid köp?", da: "Egenkapital ved køb?", fi: "Oma pääoma oston yhteydessä?", de: "Eigenkapital beim Kauf?", fr: "Fonds propres à l'achat ?", es: "¿Capital propio en la compra?") }
    var addAssetEquitySub: String { s(en: "How much did each of you put in? Optional — recorded as the first contributions on the asset.", nb: "Hvor mye la hver av dere inn? Valgfritt — registreres som de første bidragene på eiendelen.", sv: "Hur mycket la var och en av er in? Valfritt — registreras som de första bidragen på tillgången.", da: "Hvor meget lagde hver af jer ind? Valgfrit — registreres som de første bidrag på aktivet.", fi: "Kuinka paljon kukin teistä maksoi? Vapaaehtoista — kirjataan ensimmäisiksi maksuiksi varallisuudelle.", de: "Wie viel hat jeder von euch eingebracht? Optional — wird als erste Einzahlungen auf den Vermögenswert erfasst.", fr: "Combien chacun a-t-il apporté ? Facultatif — enregistré comme premiers apports sur l'actif.", es: "¿Cuánto aportó cada uno? Opcional — se registra como las primeras aportaciones del activo.") }
    var addAssetSkip: String { s(en: "Skip", nb: "Hopp over", sv: "Hoppa över", da: "Spring over", fi: "Ohita", de: "Überspringen", fr: "Ignorer", es: "Omitir") }
    ...
    var contribDelete: String        { s(en: "Delete contribution", nb: "Slett bidrag", sv: "Ta bort bidrag", da: "Slet bidrag", fi: "Poista maksu", de: "Beitrag löschen", fr: "Supprimer la contribution", es: "Eliminar aportación") }
    ...
    var close: String { s(en: "Close", nb: "Lukk", sv: "Stäng", da: "Luk", fi: "Sulje", de: "Schließen", fr: "Fermer", es: "Cerrar") }
    ...
    var assetAddPhoto: String       { s(en: "Add photo",        nb: "Legg til bilde",    sv: "Lägg till bild",    da: "Tilføj billede",     fi: "Lisää kuva",          de: "Foto hinzufügen",    fr: "Ajouter une photo",    es: "Añadir foto") }
    var assetChangePhoto: String    { s(en: "Change photo",     nb: "Bytt bilde",        sv: "Byt bild",          da: "Skift billede",      fi: "Vaihda kuva",         de: "Foto ändern",        fr: "Changer la photo",     es: "Cambiar foto") }
    var assetReceipt: String        { s(en: "Receipt",          nb: "Kvittering",        sv: "Kvitto",            da: "Kvittering",         fi: "Kuitti",              de: "Quittung",           fr: "Reçu",                 es: "Recibo") }
    var assetAddReceipt: String     { s(en: "Add receipt",      nb: "Legg til kvittering", sv: "Lägg till kvitto", da: "Tilføj kvittering",  fi: "Lisää kuitti",        de: "Quittung hinzufügen", fr: "Ajouter un reçu",     es: "Añadir recibo") }
    var assetReceiptHint: String    { s(en: "Upload a receipt for this asset", nb: "Last opp kvittering for denne eiendelen", sv: "Ladda upp ett kvitto för denna tillgång", da: "Upload en kvittering for dette aktiv", fi: "Lataa kuitti tälle omaisuudelle", de: "Quittung für dieses Vermögen hochladen", fr: "Téléverser un reçu pour ce bien", es: "Sube un recibo de este activo") }
    var assetImageUploadFailed: String { s(en: "The image could not be uploaded. Please try again.", nb: "Bildet kunne ikke lastes opp. Prøv igjen.", sv: "Bilden kunde inte laddas upp. Försök igen.", da: "Billedet kunne ikke uploades. Prøv igen.", fi: "Kuvan lataus epäonnistui. Yritä uudelleen.", de: "Das Bild konnte nicht hochgeladen werden. Bitte erneut versuchen.", fr: "L'image n'a pas pu être téléversée. Veuillez réessayer.", es: "No se pudo subir la imagen. Inténtalo de nuevo.") }
    ...
    var bankIDSharePartnerLink: String { s(en: "Share your partner's signing link", nb: "Del signeringslenke med partner", sv: "Dela partnerns signeringslänk", da: "Del partnerens signeringslink", fi: "Jaa kumppanin allekirjoituslinkki", de: "Signierlink des Partners teilen", fr: "Partager le lien de signature du partenaire", es: "Compartir enlace de firma de tu pareja") }
    ...
    var bankIDCreditActivationFailed: String { s(en: "The purchase was completed, but the signing credit could not be activated. Please contact support.", nb: "Kjøpet ble fullført, men signeringskreditten kunne ikke aktiveres. Ta kontakt med support.", sv: "Köpet slutfördes, men signeringskrediten kunde inte aktiveras. Kontakta support.", da: "Købet blev gennemført, men signeringskreditten kunne ikke aktiveres. Kontakt support.", fi: "Osto suoritettiin, mutta allekirjoituskrediittiä ei voitu aktivoida. Ota yhteyttä tukeen.", de: "Der Kauf wurde abgeschlossen, aber das Signaturguthaben konnte nicht aktiviert werden. Bitte kontaktieren Sie den Support.", fr: "L'achat a été effectué, mais le crédit de signature n'a pas pu être activé. Veuillez contacter le support.", es: "La compra se completó, pero el crédito de firma no pudo activarse. Contacta con soporte.") }
    ...
    // MARK: Equity overview (redesigned Egenkapital tab)
    var equityOverviewTitle: String  { s(en: "Equity overview", nb: "Egenkapitaloversikt", sv: "Översikt eget kapital", da: "Egenkapitaloversigt", fi: "Oman pääoman yhteenveto", de: "Eigenkapitalübersicht", fr: "Aperçu des capitaux propres", es: "Resumen de patrimonio") }
    var equityUpdated: String        { s(en: "Updated", nb: "Oppdatert", sv: "Uppdaterad", da: "Opdateret", fi: "Päivitetty", de: "Aktualisiert", fr: "Mis à jour", es: "Actualizado") }
    var equityTabSub: String         { s(en: "See today's calculated value and split for your shared assets.", nb: "Se dagens beregnede verdi og fordeling for deres felles eiendeler.", sv: "Se dagens beräknade värde och fördelning för era gemensamma tillgångar.", da: "Se dagens beregnede værdi og fordeling for jeres fælles aktiver.", fi: "Katso yhteisten varojen tämänpäiväinen laskettu arvo ja jako.", de: "Sehen Sie den heute berechneten Wert und die Aufteilung Ihrer gemeinsamen Vermögenswerte.", fr: "Consultez la valeur calculée et la répartition de vos actifs communs.", es: "Consulta el valor calculado y la distribución de vuestros activos comunes.") }
    var equityEstimatedSaleToday: String { s(en: "Estimated if sold today", nb: "Estimert ved salg i dag", sv: "Uppskattat vid försäljning idag", da: "Estimeret ved salg i dag", fi: "Arvioitu jos myytäisiin tänään", de: "Geschätzt bei Verkauf heute", fr: "Estimé en cas de vente aujourd'hui", es: "Estimado si se vendiera hoy") }
    var equityPerAsset: String       { s(en: "Equity per asset", nb: "Egenkapital per eiendel", sv: "Eget kapital per tillgång", da: "Egenkapital pr. aktiv", fi: "Oma pääoma varoittain", de: "Eigenkapital pro Vermögenswert", fr: "Capitaux propres par actif", es: "Patrimonio por activo") }
    var equityYourCalculated: String { s(en: "Your calculated equity", nb: "Din beregnede egenkapital", sv: "Ditt beräknade egna kapital", da: "Din beregnede egenkapital", fi: "Laskettu oman pääomasi", de: "Ihr berechnetes Eigenkapital", fr: "Vos capitaux propres calculés", es: "Tu patrimonio calculado") }
    var equityCombinedNetValue: String { s(en: "Combined net value", nb: "Samlet nettoverdi", sv: "Sammanlagt nettovärde", da: "Samlet nettoværdi", fi: "Yhteinen nettoarvo", de: "Gesamtnettowert", fr: "Valeur nette combinée", es: "Valor neto combinado") }
    var equityYourOwnership: String  { s(en: "Your share", nb: "Din eierandel", sv: "Din ägarandel", da: "Din ejerandel", fi: "Omistusosuutesi", de: "Ihr Anteil", fr: "Votre part", es: "Tu participación") }
    var filterAll: String            { s(en: "All", nb: "Alle", sv: "Alla", da: "Alle", fi: "Kaikki", de: "Alle", fr: "Tous", es: "Todos") }
    ...
    var settingsInterestRateFooter: String { s(en: "The interest rate determines how much each contribution grows over time.", nb: "Renten bestemmer hvor mye hvert bidrag vokser over tid.", sv: "Räntan avgör hur mycket varje bidrag växer över tid.", da: "Renten bestemmer, hvor meget hvert bidrag vokser over tid.", fi: "Korko määrittää, kuinka paljon kukin maksu kasvaa ajan myötä.", de: "Der Zinssatz bestimmt, wie stark jeder Beitrag über die Zeit wächst.", fr: "Le taux d'intérêt détermine la croissance de chaque contribution au fil du temps.", es: "El tipo de interés determina cuánto crece cada aportación con el tiempo.") }
